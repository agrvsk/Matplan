...
public class Z_ART_RecEnhRepository : RepositoryBase<Z_ART_RecEnh>, IZ_ART_RecEnhRepository
{
    public Z_ART_RecEnhRepository(MatplanDBContext context) : base(context)
    {
    }

    public async Task<Z_ART_RecEnh?> GetZ_ART_RecEnhAsync(byte id, bool trackChanges = false)
    {
        var retur = await FindByCondition(c => c.Storedpfu.Equals(id), trackChanges).FirstOrDefaultAsync();
//        if (retur == null) throw new Z_ART_RecEnhNotFoundException(id);
        return retur;
    }


    public async Task<IPagedList<Z_ART_RecEnh>> GetZ_ART_RecEnhListAsync(KodtabellByteRequestParams requestParams, bool trackChanges = false)
    {
        var query = FindAll(trackChanges);
        query = query.OrderBy(o => o.Storedpfu);

        var retur = await PagedList<Z_ART_RecEnh>.CreateAsync(query, requestParams.PageNumber, requestParams.PageSize);
        return (IPagedList<Z_ART_RecEnh>)retur;
    }


    public async Task<bool> Z_ART_RecEnhExistAsync(byte id)
    {
        return await Context.Z_ART_RecEnh.AnyAsync(c => c.Storedpfu == id);
    }

    //public new Z_ART_RecEnh Insert(Z_ART_RecEnh Z_ART_RecEnh)
    //{
    //    base.Insert(Z_ART_RecEnh);
    //    return Z_ART_RecEnh;
    //}

    //public new Z_ART_RecEnh Update(Z_ART_RecEnh Z_ART_RecEnh)
    //{
    //    base.Update(Z_ART_RecEnh);
    //    return Z_ART_RecEnh;
    //}

    //public override void Delete(Z_ART_RecEnh Z_ART_RecEnh)
    //{
    //    base.Delete(Z_ART_RecEnh);
    //}
