...
public class Z_BristViaSMSRepository : RepositoryBase<Z_BristViaSMS>, IZ_BristViaSMSRepository
{
    public Z_BristViaSMSRepository(MatplanDBContext context) : base(context)
    {
    }

    public async Task<Z_BristViaSMS?> GetZ_BristViaSMSAsync(byte id, bool trackChanges = false)
    {
        var retur = await FindByCondition(c => c.Storedpfu.Equals(id), trackChanges).FirstOrDefaultAsync();
//        if (retur == null) throw new Z_BristViaSMSNotFoundException(id);
        return retur;
    }


    public async Task<IPagedList<Z_BristViaSMS>> GetZ_BristViaSMSListAsync(KodtabellByteRequestParams requestParams, bool trackChanges = false)
    {
        var query = FindAll(trackChanges);
        query = query.OrderBy(o => o.Storedpfu);

        var retur = await PagedList<Z_BristViaSMS>.CreateAsync(query, requestParams.PageNumber, requestParams.PageSize);
        return (IPagedList<Z_BristViaSMS>)retur;
    }


    public async Task<bool> Z_BristViaSMSExistAsync(byte id)
    {
        return await Context.Z_BristViaSMS.AnyAsync(c => c.Storedpfu == id);
    }

    //public new Z_BristViaSMS Insert(Z_BristViaSMS Z_BristViaSMS)
    //{
    //    base.Insert(Z_BristViaSMS);
    //    return Z_BristViaSMS;
    //}

    //public new Z_BristViaSMS Update(Z_BristViaSMS Z_BristViaSMS)
    //{
    //    base.Update(Z_BristViaSMS);
    //    return Z_BristViaSMS;
    //}

    //public override void Delete(Z_BristViaSMS Z_BristViaSMS)
    //{
    //    base.Delete(Z_BristViaSMS);
    //}
